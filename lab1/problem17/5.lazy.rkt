...
(define count-number-letters-seq
  (letrec ([count-number-letters-seq-n (lambda (n)
                                         (cons (count-number-letters n) (count-number-letters-seq-n (+ n 1))))])
    (count-number-letters-seq-n 1)))

(define result (foldl1 + (take 1000 count-number-letters-seq)))
